...
la url en la que se despliega es: [https://arquisoft.github.io/dede_es1b/](https://arquisoft.github.io/dede_es1b/).
...
Si queremos desplegar la documentación en GitHub pages, estará accesible en [https://arquisoft.github.io/dede_es1b/](https://arquisoft.github.io/dede_es1b/) necesitamos ejecutar `npm run deploy`.
