...
The deployment url is: [https://arquisoft.github.io/dede_es1b/](https://arquisoft.github.io/dede_es1b/).
...
If we want to deploy it to GitHub pages, so it is accesible via [https://pglez82.github.io/dede_es1b/](https://pglez82.github.io/dede_es1b/) we need to execute `npm run deploy`.
